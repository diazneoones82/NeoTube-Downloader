...
def _ensure_test_env() -> None:
    if os.environ.get("NEOTUBE_TEST_ENV_READY"):
        return
    tmp = tempfile.mkdtemp(prefix="neotube-pytest-")
    base = Path(tmp)
    browser = base / "ui" / "dist" / "neotube" / "browser"
    ...
    os.environ["NEOTUBE_TEST_ENV_READY"] = "1"
