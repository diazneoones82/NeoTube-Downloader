...
import { NeoTubeSocket } from './neotube-socket.service';
...
export class DownloadsService {
  ...
  private socket = inject(NeoTubeSocket);
  loading = true;
  ...
  public openFolder(download: Pick<Download, 'download_type' | 'folder' | 'filename'>) {
    return this.http.post<Status>('open-folder', {
